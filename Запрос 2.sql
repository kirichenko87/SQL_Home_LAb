...
CREATE TABLE `StudentsTable`(
	...
	`Фамилия` VARCHAR(75) NOT NULL,
	`Пол` ENUM('м','ж') NOT NULL,
	`Дата рождения`DATE NOT NULL,
	`Снилс` VARCHAR(14) UNIQUE NOT NULL, 
	`Курс` TINYINT NOT NULL,
	`Группа` VARCHAR(10) NOT NULL,
	`Средний балл` FLOAT(3, 1) UNSIGNED NOT NULL,
	`Хобби` VARCHAR (50) 
	);
	

INSERT INTO `StudentsTable`(`Фамилия`,`Пол`, `Дата рождения`,`Снилс`, `Курс`,`Группа`, `Средний балл`, `Хобби`)
